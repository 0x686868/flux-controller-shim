module github.com/fluxcd/source-controller/shim

go 1.20

// Import from Git submodule to gather access to internal.
replace github.com/fluxcd/source-controller => ./../../upstream/source-controller
...
require (
	...
	github.com/fluxcd/source-controller v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/fluxcd/pkg/git v0.13.0 // indirect
	github.com/fluxcd/pkg/git/gogit v0.13.0 // indirect
